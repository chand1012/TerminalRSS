...
argument_parser.add_argument('--width', '-w', dest='width', help='The width of the skin.', default='550')
argument_parser.add_argument('--height', '-ht', dest='height', help='The height of the skin.', default='300')
